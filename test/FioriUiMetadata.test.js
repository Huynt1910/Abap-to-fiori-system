...
function controller(metadataCheck, prepare) {
  ...
  return Object.assign({}, definition, {
    _oViewModel: new Model({ analysisId: "A1", fioriUi: {
      targetPackage: "Z_UI", serviceRootUrl: "/sap/report/", busy: false, error: "", hasResult: true,
...
test("editing either input clears VALIDATED and Prepare result", () => {
  for (const propertyPath of ["/fioriUi/targetPackage", "/fioriUi/serviceRootUrl"]) {
    const instance = controller(() => Promise.resolve({ status: "VALIDATED", issues: [] }), () => Promise.resolve({}));
    instance.onFioriUiInputChange(inputEvent(propertyPath, "new value"));
